define('app/game',
    ...
    function (stage,
        ...
        Game.prototype.gameOver = function () {
            ...
            facade.clear().show(i18._('game-over'), {
                autohide: false
            });
            sound.playMusic();
        ...
        Game.prototype.splashScreen = function () {
            ...
            if (!this.options.splashscreen) {
                facade.clear().show(i18._('splash-screen-welcome-text'), {
                    autohide: false
                });
            }
        };
        ...
        Game.prototype.onGameClearStage = function () {
            ...
            dashboard.getTime().stop();
            facade.clear().show(i18._('round-well-done'), {
                autohide: false
            });
        ...
        Game.prototype.onPreloaderComplete = function () {
            ...
            if (this.options.splashscreen) {
                ...
                if (location.hash == '#contact') {
                    ...
                    gameOptions.set('window-first-time', {
                        needToShow: false
                    });
